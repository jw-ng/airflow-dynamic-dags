...
from etl_using_operator_reading_external_flat_file import create_dag


class TestEtlUsingOperatorReadingFromExternalFlatFile:
    ...
    def test_dag_should_initialise_run_etl_using_airflow_variable_operator_with_correct_source_variable_name(
        ...
        spy_operator = mocker.patch(
            "etl_using_operator_reading_external_flat_file.RunEtlUsingExternalFlatFileOperator"
        )
